...
const buttonImage = document.querySelector('.profile__button-redaction-image');

const updateAvatar = document.querySelector('.shadow_update-avatar');
const exitUpdateAvatar = document.querySelector('.modal-window__buttons-exit_update-avatar');
